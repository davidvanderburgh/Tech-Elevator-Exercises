...
SELECT AVG(lifeexpectancy) AS avg_life_expectency
FROM country
...
SELECT MAX(population / surfacearea) AS max_population_density
FROM country;

-- 15. The population density and life expectancy of the top ten countries with the 
-- highest life expectancies in descending order. 
-- (highest life expectancies in world: 83.5, 166.6666, "Andorra")
SELECT TOP 10 (population/surfacearea) AS population_density, lifeexpectancy AS life_expectancy, name
FROM country
...
SELECT gnp-gnpold AS gnp_difference, ABS(gnp-gnpold) abs_gnp_difference, name
FROM country
