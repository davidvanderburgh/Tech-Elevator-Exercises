...
namespace Exercises
{
    public partial class Exercises
    {
        /*
         ...
         array. You do not need a separate if-statement for the length-0 case; the for-loop 
         should naturally execute 0 times in that case, so it just works. The syntax to 
        ...
        {
            int[] sequentialNumbers = new int[n];
            for (int i = 0; i < n; i++)
            {
