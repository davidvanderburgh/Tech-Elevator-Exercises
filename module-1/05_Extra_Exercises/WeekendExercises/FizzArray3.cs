...
namespace Exercises
{
    public partial class Exercises
    {
        ...
        {
            //  create a new array of size (end - start)
            //  for loop
            //      array[i] = start + i
            //  return array

            int[] sequentialNumbersFromStart = new int[end - start];
            for (int i = 0; i < (end - start); i++)
            {
                sequentialNumbersFromStart[i] = start + i;
            }
            return sequentialNumbersFromStart;
